  ...
  async saveCliente(cliente: ClienteDTO): Promise<ClienteDTO> {
    ...
    try {
      ...
      await supabase.from('clientes').upsert({
        ...
        complemento: validatedWithId.endereco?.complemento || null,
        ...
        segmento: validatedWithId.segmento || null,
        porte: validatedWithId.porteEmpresa || null,
        site: validatedWithId.site || null,
        observacoes: validatedWithId.observacoes || null,
        updated_at: new Date().toISOString(),
      }, { onConflict: 'id' });
    } catch (e) {
