    ...
    <div className="space-y-6 animate-fade-in pt-1">
      ...
      {playbooks.length === 0 ? (
        <div className="p-12 text-center text-muted-foreground bg-muted/10 rounded-2xl border border-dashed my-4 animate-fade-in">
          <BookOpen className="w-12 h-12 text-orange-500 opacity-40 mx-auto mb-3" />
          <h4 className="font-bold text-sm text-foreground">Nenhum playbook comercial cadastrado.</h4>
          <p className="text-xs mt-1">Crie playbooks de prospecção e fechamento para capacitar a equipe comercial.</p>
        </div>
      ) : (
