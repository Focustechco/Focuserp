...
const INITIAL_BENEFICIOS: PlanoBeneficio[] = [
  {
    id: 'ben-1',
    nome: 'Plano de Saúde Executivo (Nacional)',
    categoria: 'Saúde & Odonto',
    operadora: 'Bradesco Saúde Top Nacional',
    valorMensalTotal: 680,
    custoEmpresaR$: 580,
    descontoColaboradorR$: 100,
    totalVidas: 18,
    obrigatorio: false,
    status: 'Ativo'
  },
  {
    id: 'ben-2',
    nome: 'Vale Refeição & Alimentação Flexível',
    categoria: 'Alimentação & Refeição',
    operadora: 'Flash Benefícios Flexíveis',
    valorMensalTotal: 950,
    custoEmpresaR$: 900,
    descontoColaboradorR$: 50,
    totalVidas: 22,
    obrigatorio: true,
    status: 'Ativo'
  },
  {
    id: 'ben-3',
    nome: 'Plano Odontológico Premium',
    categoria: 'Saúde & Odonto',
    operadora: 'OdontoPrev Master',
    valorMensalTotal: 65,
    custoEmpresaR$: 65,
    descontoColaboradorR: 0,
    totalVidas: 16,
    obrigatorio: false,
    status: 'Ativo'
  },
  {
    id: 'ben-4',
    nome: 'Wellhub / Gympass Corporativo',
    categoria: 'Bem-Estar & Educação',
    operadora: 'Wellhub Corporate (Plano Gold)',
    valorMensalTotal: 120,
    custoEmpresaR$: 80,
    descontoColaboradorR$: 40,
    totalVidas: 14,
    obrigatorio: false,
    status: 'Ativo'
  },
  {
    ...
    operadora: 'Porto Seguro Vida Coletivo',
    valorMensalTotal: 45,
    custoEmpresaR$: 45,
    descontoColaboradorR$: 0,
    totalVidas: 22,
  ...
  {
    id: 'ben-6',
    nome: 'Auxílio Conectividade & Home Office',
    categoria: 'Mobilidade & Transporte',
    operadora: 'Focus ERP Direto em Conta',
    valorMensalTotal: 250,
    custoEmpresaR$: 250,
    descontoColaboradorR$: 0,
    totalVidas: 12,
    obrigatorio: false,
