...
const getCategoryColor = (categoria: CategoriaAgenda) => {
  switch(categoria) {
    ...
    case 'Recorrência': return 'bg-orange-100 text-orange-800 border-orange-200 dark:bg-orange-950/50 dark:text-orange-300 dark:border-orange-800 font-semibold';
