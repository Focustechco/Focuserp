...
import {
  ...
  DollarSign, ShieldCheck, Trash2, Edit2, PieChart, BarChart3, List
} from 'lucide-react';
...
export function MobileFiscalView() {
  ...
  const [activeSection, setActiveSection] = useState<'documentos' | 'dashboard'>('documentos');
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-zinc-950 pb-24">
      ...
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-md border-b px-3.5 py-2.5 space-y-2">
        {/* Busca, Filtros & Botão Emitir para Documentos */}
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-hide py-0.5">
          {[
            { id: 'documentos', label: 'Documentos Fiscais', icon: Receipt },
            { id: 'dashboard', label: 'Monitor Tributário', icon: PieChart },
          ].map((sec) => {
            const Icon = sec.icon;
        ...
        {/* Category Pills (Horizontal Scroll) para Documentos */}
