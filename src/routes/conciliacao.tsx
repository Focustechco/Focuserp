...
import { MobileConciliacaoView } from "@/features/conciliacao/components/MobileConciliacaoView";
  ...
  return (
    <>
      <div className="md:hidden">
        <MobileConciliacaoView />
      </div>
      <div className="hidden md:flex flex-col gap-4 sm:gap-6 p-3 sm:p-6 max-w-[1400px] mx-auto w-full">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">Conciliação Bancária</h1>
