...
import { MobileComercialView } from "@/features/comercial/components/MobileComercialView";
import { 
...
function ModuloComercialOpsPage() {
  ...
  return (
    <>
      ...
      {/* Versão Desktop */}
      <div className="hidden md:flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full animate-fade-in">
