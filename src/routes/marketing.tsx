...
import { MobileMarketingView } from "@/features/marketing/components/MobileMarketingView";
...
function MarketingRoute() {
  return (
    <>
      ...
      {/* Versão Desktop */}
      <div className="hidden md:flex flex-1 space-y-4 p-4 md:p-8 pt-6 h-[calc(100vh-4rem)] flex-col overflow-hidden">
